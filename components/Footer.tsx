    ...
    return (
        <footer className="bg-secondary text-secondary-foreground pt-16 pb-8">
            <div className="container px-4 md:px-6">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
                    <div className="space-y-4">
                        <Link href="/" className="flex items-center space-x-2">
                            ...
                            <span className="font-bold text-xl tracking-tight">AD Trades</span>
                        </Link>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm text-secondary-foreground/80">
                            <li><Link href="/services/furnace-installation" className="hover:text-primary transition-colors">Furnace Installation</Link></li>
                            <li><Link href="/services/ac-installation" className="hover:text-primary transition-colors">AC Installation</Link></li>
                            <li><Link href="/services/hvac-repair" className="hover:text-primary transition-colors">HVAC Repair</Link></li>
                            <li><Link href="/services/heat-pump-installation" className="hover:text-primary transition-colors">Heat Pump</Link></li>
                ...
                <div className="border-t border-secondary-foreground/20 pt-8 mt-8 flex flex-col md:flex-row justify-between items-center text-sm text-secondary-foreground/60">
